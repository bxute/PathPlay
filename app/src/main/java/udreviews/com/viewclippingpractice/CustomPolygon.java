...
public class CustomPolygon extends View {
    ...
    public CustomPolygon(Context context) {
        super(context);
        init();
    }

    public CustomPolygon(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public CustomPolygon(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
